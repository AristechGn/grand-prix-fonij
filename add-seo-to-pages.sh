...
# Script pour ajouter automatiquement le composant SEO aux pages React
# Usage: ./add-seo-to-pages.sh

echo "Ajout du composant SEO aux pages React..."
...
pages=(
    ...
    "resources/js/pages/Candidater.tsx"
...
echo "Terminé! Les pages ont été mises à jour avec le composant SEO."
