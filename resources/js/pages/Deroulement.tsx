...
import { IconCalendarEvent, IconUsers, IconTrophy, IconClock } from '@tabler/icons-react';
...
const Keypad = () => {
    return (
        <div className="flex h-full w-full flex-col items-center justify-center gap-[2px] p-1">
            <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
                {/* Lignes de touches simplifiées */}
                <div className="flex h-6 w-6 items-center justify-center rounded-[3.5px] bg-[#0A090D]"></div>
                {/* Répété pour créer l'effet visuel du clavier */}
            </div>
        </div>
    );
};
...
const Trackpad = () => {
    return (
        <div className="absolute inset-x-0 bottom-5 mx-auto h-32 w-[60%] rounded-lg bg-[#272729]"></div>
    );
};
        ...
        <MainLayout>
            ...
            <div className="bg-gradient-to-b from-gray-50 to-white">
                <MacbookScroll
                    title={
                        <div>
                            <div className="inline-block rounded-full bg-emerald-100 px-4 py-1 text-sm font-medium text-emerald-800 mb-6">
                    ...
                    badge={
                        <div className="flex items-center gap-2 bg-emerald-700 text-white px-3 py-1.5 rounded-full text-sm font-medium">
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                <div className="mb-2 rounded-full bg-emerald-50 p-3">
                                    <stat.icon className="h-6 w-6 text-emerald-600" stroke={1.5} />
                                </div>
                                <span className="text-sm font-medium text-gray-900 md:text-base">{stat.label}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
                            ...
                            >
                                <div className={`flex flex-col md:flex-row items-start ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                                    ...
                                    <div className={cn(
                                        ...
                                        <div className={cn(
                                            "bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border",
                                            index % 2 === 0 ? 'ml-4 md:ml-0' : 'mr-4 md:mr-0',
                                            colorVariants[phase.color].border
                                        )}>
                                            <div className="p-6">
                                                <div className={cn(
                                                    "inline-block px-3 py-1 rounded-full text-sm font-medium mb-3",
                                                    colorVariants[phase.color].date
                                                )}>
                                                    {phase.date}
                                                </div>
                                                <h3 className={cn(
                                                    "text-xl font-bold mb-3",
                                                    colorVariants[phase.color].title
                                                )}>
            ...
            {/* CTA Section */}
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-700 to-emerald-900">
                    ...
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                            <a 
                                ...
                                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-white px-8 py-4 font-medium text-emerald-700 shadow-lg transition-all duration-300 hover:bg-emerald-50 hover:shadow-xl"
                            >
                            ...
                            <a 
                                href="/contact"
                                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white px-8 py-4 font-medium text-white transition-all duration-300 hover:bg-white/10"
                            >
                                Nous contacter
                            </a>
                        </div>
