        ...
        <MainLayout>
            ...
            >
                ...
                <div className="absolute inset-0 z-10 overflow-hidden">
                    ...
                    ></motion.div>
                    <motion.div 
                        className="absolute bottom-1/4 right-5 w-10 h-10 sm:w-16 sm:h-16 md:w-32 md:h-32 rounded-full bg-yellow-500/20 blur-xl"
                        variants={fadeIn}
                        animate={{ 
                            x: [0, -10, 0],
                            y: [0, 10, 0],
                ...
                >
                    <div className="max-w-4xl text-center">
                        <motion.div 
                            className="mb-6 sm:mb-8 inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-yellow-500/50 backdrop-blur-sm"
                            variants={fadeInUp}
                        >
                            <ShieldOff className="h-12 w-12 sm:h-16 sm:w-16 text-white" strokeWidth={1.5} />
                        </motion.div>
