            ...
            >
                ...
                >
                    <div className="max-w-4xl text-center">
                        <motion.div 
                            className="mb-6 sm:mb-8 inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-primary-dark/50 backdrop-blur-sm"
                            variants={fadeInUp}
                        >
                            <Search className="h-12 w-12 sm:h-16 sm:w-16 text-white" strokeWidth={1.5} />
                        </motion.div>
