        ...
        <MainLayout>
            ...
            >
                ...
                <div className="absolute inset-0 z-10 overflow-hidden">
                    ...
                    ></motion.div>
                    <motion.div 
                        className="absolute bottom-1/4 right-5 w-10 h-10 sm:w-16 sm:h-16 md:w-32 md:h-32 rounded-full bg-green-500/20 blur-xl"
                        variants={fadeIn}
                        animate={{ 
                            x: [0, -10, 0],
                            y: [0, 10, 0],
                ...
                >
                    <div className="max-w-4xl text-center">
                        <motion.div 
                            className="mb-6 sm:mb-8 inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-green-500/50 backdrop-blur-sm"
                            variants={fadeInUp}
                        >
                            <motion.div
                                animate={refreshAnimation}
                            >
                                <RefreshCw className="h-12 w-12 sm:h-16 sm:w-16 text-white" strokeWidth={1.5} />
                            </motion.div>
                        </motion.div>
                        ...
                        <motion.p 
                            ...
                            variants={fadeInUp}
                        >
                            Votre session a expiré ou votre jeton CSRF est invalide. Veuillez actualiser la page et réessayer.
                        </motion.p>
