...
import { ChevronRight, Wrench, Construction } from 'lucide-react';
...
export default function Maintenance() {
    ...
    // Animation de l'outil qui tourne
    const toolAnimation = {
        rotate: [0, 10, -10, 10, 0],
        transition: {
            duration: 1.5,
        ...
        <MainLayout>
            ...
            >
                ...
                <div className="absolute inset-0 z-10 overflow-hidden">
                    ...
                    ></motion.div>
                    <motion.div 
                        className="absolute bottom-1/4 right-5 w-10 h-10 sm:w-16 sm:h-16 md:w-32 md:h-32 rounded-full bg-purple-500/20 blur-xl"
                        variants={fadeIn}
                        animate={{ 
                            x: [0, -10, 0],
                            y: [0, 10, 0],
                ...
                >
                    <div className="max-w-4xl text-center">
                        <motion.div 
                            className="mb-6 sm:mb-8 inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-purple-500/50 backdrop-blur-sm"
                            variants={fadeInUp}
                        >
                            <motion.div
                                animate={toolAnimation}
                            >
                                <Construction className="h-12 w-12 sm:h-16 sm:w-16 text-white" strokeWidth={1.5} />
                            </motion.div>
                        </motion.div>
                        
                        <motion.h1 
                            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-shadow-lg drop-shadow-2xl"
                            variants={fadeInUp}
                        >
                            Site en Maintenance
                        </motion.h1>
                        ...
                        <motion.p 
                            ...
                            variants={fadeInUp}
                        >
                            Nous effectuons actuellement des mises à jour pour améliorer votre expérience. Nous serons de retour très bientôt !
                        </motion.p>
                        ...
                        >
                            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                                ...
                                >
                                    Visiter le site FONIJ
                                </Link>
                            </motion.div>
                            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                                <a
                                    href="mailto:contact@fonij.gov.gn"
                        ...
                        <motion.div 
                            ...
                            variants={fadeInUp}
                        >
                            <p className="text-sm sm:text-base mb-4 text-white/80">
                                Temps estimé avant le retour du site :
                            </p>
                            <div className="flex justify-center space-x-2 sm:space-x-4">
                                <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 sm:px-4 sm:py-3">
                                    <div className="text-xl sm:text-2xl font-bold">00</div>
                                ...
                                <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2 sm:px-4 sm:py-3">
                                    <div className="text-xl sm:text-2xl font-bold">00</div>
                                    <div className="text-xs sm:text-sm">Secondes</div>
                                </div>
                            </div>
                        </motion.div>
                    </div>
